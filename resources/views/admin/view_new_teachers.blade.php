                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                  ...
                                  @endif
                                  <td>
                                <form action="{{ route('teacherscompleteregister') }}" method="post">
                                  @csrf
                                  <input type="hidden" name="full_name" value="{{ $t['name'] }}">
                                  <input type="hidden" name="teacher_email" value="{{ $t['email'] }}">
                                  <input type="hidden" name="teacher_number" value="{{ $t['number'] }}">
                            ...
                            <td><a class="btn btn-danger" href="teacherscourses/{{ $t->id }}">Delete</a></td>
                            @empty
                            No teacher
                          </tr>
                            @endforelse
