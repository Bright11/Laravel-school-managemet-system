            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('addclassroomtodb') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="room_location" placeholder="Room Location">
                                      </div>
                                      <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Room Capacicty</label>
                                        <input type="number" class="form-control" name="room_capacity" placeholder="Room Capacicty">
                                      </div>
                                    <div class="mb-3">
