                                ...
                                <form action="/">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="student_number" placeholder="Phone number">
                                      </div>
                                    <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label">student qualification</label>
